...
`data/benchmark/fixtures/six_papers/P003_Pan_2025_FeMo_MgO_Methane_CNT/`
...
- `data/processed/analysis/derived/nanopub_demo/P003_Pan_2025_FeMo_MgO_Methane_CNT.trig` (combined five-run dataset)
- `data/processed/analysis/derived/nanopub_demo/runs/*.trig` (five independent run-level nanopublications)
- `data/processed/analysis/derived/nanopub_demo/P003_Pan_2025_FeMo_MgO_Methane_CNT_mapping.json`
- `data/processed/analysis/derived/nanopub_demo/metrics.json`
- `data/processed/analysis/derived/nanopub_demo/completeness_report.json`
