...
SOURCES = {
    "LIT_15F49C3012600D0B": {
        ...
        ], "issue": "Main five catalyst comparison extracted; steam/feed details and any additional operating-condition series require independent evidence review."
    },
    ...
    "LIT_9B43B350883D2B6F": {
        ...
        ], "issue": "The table gives three activation-condition runs; catalyst text, purification basis, and mixed amorphous/metal residue content need independent evidence review."
    },
}
