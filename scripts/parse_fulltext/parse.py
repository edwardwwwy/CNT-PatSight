...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--candidate-db", type=Path, default=ROOT / "data/interim/extraction_candidates/extraction_candidates.sqlite3")
    parser.add_argument("--raw-text-dir", type=Path, default=ROOT / "data/raw/fulltext/text")
    parser.add_argument("--parsed-text-dir", type=Path, default=ROOT / "data/interim/parsed_text")
    parser.add_argument("--section-csv", type=Path, default=ROOT / "data/interim/extraction_candidates/paper_text_section.csv")
    parser.add_argument("--span-csv", type=Path, default=ROOT / "data/interim/extraction_candidates/candidate_experiment_span.csv")
    parser.add_argument("--status-csv", type=Path, default=ROOT / "data/interim/extraction_candidates/parse_source_status.csv")
    parser.add_argument("--ocr-queue-csv", type=Path, default=ROOT / "data/interim/extraction_candidates/ocr_queue.csv")
    parser.add_argument("--reports-dir", type=Path, default=ROOT / "data/interim/extraction_candidates/reports")
