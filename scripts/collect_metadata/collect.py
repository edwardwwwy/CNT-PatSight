...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--master-csv", type=Path, default=ROOT / "data" / "raw" / "metadata" / "literature_master.csv")
    parser.add_argument("--raw-dir", type=Path, default=ROOT / "data" / "raw" / "metadata" / "api_responses")
    parser.add_argument("--reports-dir", type=Path, default=ROOT / "data" / "raw" / "metadata" / "run_reports")
